                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Thêm mới size giày</li>
                        </ol>                
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("size.store")}}" id="quickForm">
                                @csrf
                                <div class="card-body">                           
                                    <div class="form-group">
                                        <label>Tên kích thước giày</label>
                                        <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="VD: 32">
                                    </div>                                                          
                                    <div class="form-group">
