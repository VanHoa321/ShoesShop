                ...
                <div class="row">                   
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("slide.store")}}" id="quickForm">
                                @csrf
                                <div class="card-body">                                                               
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="sub_title" value="{{ old('sub_title') }}" class="form-control" placeholder="Nhập tiêu đề phụ">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Liên kết</label>
                                                        <input type="text" name="alias" value="{{ old('alias') }}" class="form-control" placeholder="Nhập liên kết (nếu có)">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Vị trí</label>
                                                        <input type="number" name="order" value="{{ old('order') }}" class="form-control" placeholder="Nhập vị trí">
                                                    </div>
                                                </div>                         
                                            </div>
                                            <div class="form-group">
