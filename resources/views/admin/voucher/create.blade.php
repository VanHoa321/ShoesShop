            ...
            <div class="row mb-2">
                <div class="col-sm-6">         
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Thêm mới Voucher</li>
                    </ol>               
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form method="post" action="{{ route('voucher.store') }}" id="voucherForm">
                            @csrf
                            <div class="card-body">                                
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" value="{{ old('code') }}" class="form-control" placeholder="VD: TET2025">
                                        </div>
                                    </div>                                       
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="type" class="form-control select2bs4" style="width: 100%">
                                                <option value="1" {{ old('type') == 1 ? 'selected' : '' }}>Theo số tiền</option>
                                                <option value="2" {{ old('type') == 2 ? 'selected' : '' }}>Theo phần trăm</option>
                                            </select>
                                        </div>
                                    </div>                            
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="discount_value" value="{{ old('discount_value') }}" class="form-control" placeholder="VD: 10000">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="min_order_amount" value="{{ old('min_order_amount') }}" class="form-control" placeholder="VD: 100000">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="quantity" value="{{ old('quantity') }}" class="form-control" placeholder="VD: 10">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-3" name="description" placeholder="Nhập mô tả voucher giảm giá (nếu cần)" style="height: 100px">{{ old('description') }}</textarea>
                                </div>            
                            </div>
