                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("customer.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                           
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Họ tên</label>
                                                        <input type="text" name="name" class="form-control" placeholder="VD: Võ Văn Hòa" value="{{old('name', $edit->name)}}">
                                                    </div>
                                                </div>
                                            </div>      
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="email" name="email" class="form-control" placeholder="VD: vanhoa12092003@gmail.com" value="{{old('email', $edit->email)}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Số điện thoại</label>
                                                        <input type="text" name="phone" class="form-control" placeholder="VD: 0349191354" value="{{old('phone', $edit->phone)}}">
                                                    </div>
                                                </div>
                                            </div>                                                                                                          
                                        </div>
