                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("color.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ old('name', $edit->name) }}" class="form-control" placeholder="VD: Đỏ, Xanh dương...">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <input type="color" id="colorPicker" value="{{ old('code', $edit->code) }}" style="width: 60px; height: 38px; border: none; cursor: pointer;">
                                                    <input type="text" name="code" id="colorCodeInput" value="{{ old('code', $edit->code) }}" class="form-control ml-3" style="max-width: 100%;" placeholder="VD: #FF0000">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
